...
public final class Pair<L, R> {
  ...
  /**
   * Creates a new pair, with {@code pair(t, this.left)} as the left item and the the right value of
   * {@code this} as the right.
   *
   ...
   * @return a new pair, with {@code pair(t, this.left)} as the left item and the the right value of
   * {@code this} as the right
   */
  ...
  /**
   * Creates a new pair, with {@code pair(t, this.right)} as the right item and the the left value
   * of {@code this} as the left.
   *
   ...
   * @return a new pair, with {@code pair(t, this.right)} as the right item and the the left value
   * of {@code this} as the left
   */
   ...
   * @return a new pair, with the left item being the result of applying the given function to the
   * left item of {@code this}
   ...
   * @return a new pair, with the right item being the result of applying the given function to the
   * right item of {@code this}
   * @throws Exception any thrown by {@code function}
   */
  ...
  /**
   * A pair is equal if its left and right items are equal to the left and right items of {@code
   * this} respectively.
   *
